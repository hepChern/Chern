...
class TestVAlgorithm(unittest.TestCase):
    ...
    def test_ls(self):
        ...
        try:
            ...
            with patch.object(algorithm, 'path', test_path), \
                 ...
                 patch('Chern.kernel.vobject.VObject.ls') as mock_super_ls:
    ...
    def test_create_algorithm(self, mock_input, mock_subprocess):
        ...
        with patch('os.mkdir') as mock_mkdir, \
             patch('Chern.utils.metadata.ConfigFile') as mock_config, \
            ...
            mock_subprocess.assert_called_with(
                f"vim {test_path}/.chern/README.md", shell=True
            )
    ...
    def test_create_algorithm_with_template(self, mock_input,
        ...
        with patch('os.mkdir') as mock_mkdir, \
             patch('Chern.utils.metadata.ConfigFile'), \
