...
class AliasManagement(Core):
    ...
    """
    def path_to_alias(self, path): # UnitTest: DONE
    ...
    def alias_to_path(self, alias): # UnitTest: DONE
    ...
    def alias_to_impression(self, alias): # UnitTest: DONE
    ...
    def has_alias(self, alias): # UnitTest: DONE
        """ Check if the alias is in the alias list."""
        alias_to_path = self.config_file.read_variable("alias_to_path", {})
        return alias in alias_to_path.keys()

    def remove_alias(self, alias): # UnitTest: DONE
    ...
    def set_alias(self, alias, path): # UnitTest: DONE
    ...
    def get_alias_list(self): # UnitTest: DONE
        """ Get the alias list."""
        alias_to_path = self.config_file.read_variable("alias_to_path", {})
